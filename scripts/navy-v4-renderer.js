...
.designC .C-topbar{display:flex;justify-content:space-between;align-items:center;padding:10px 24px;background:var(--c-ink);color:#fff;font-family:"IBM Plex Mono",monospace;font-size:12px;position:sticky;top:0;z-index:10;border-bottom:3px solid var(--c-accent);}
...
.designC .C-header{padding:32px 40px 40px;background:var(--c-paper);border-bottom:3px solid var(--c-accent);}
