...
window.POST = {
  ...
  title: "Korean Business Immigration Visa Overview — D-9-4, D-9-5, and Why Franchise Is a Practical Path",
  ...
  sections: [
    {
      id: "s1",
      heading: "The Korean business visa is not only D-8",
      blocks: [
        { type: "p", text: "For foreign nationals looking to do business in Korea, the first visa category they usually encounter is the <b>D-8 visa</b>. Overseas immigration consultancies, the Korean government's English-language materials, and most press coverage all introduce D-8 as Korea's \"business visa.\" As a result, many applicants assume that a D-8 is required to start any business in Korea." },
        { type: "p", text: "In practice, however, D-8 is designed for <b>foreign nationals who establish a corporation or invest in an existing one</b>. Its subcategories make this clear: D-8-1 for essential specialists (such as executives) of a foreign-invested corporation, D-8-2 for founders of venture companies, D-8-3 for joint venture partners with a Korean national, and D-8-4 for technology-based startup founders. All of them presuppose a <b>corporation or investment-backed enterprise</b>. The applicant sets up or joins a corporate entity and resides in Korea as its representative or officer." },
        { type: "p", text: "But most people considering Business Immigration are not planning a corporate-level venture or a tech startup. They are planning <b>sole-proprietor small businesses</b>: convenience stores, cafés, unmanned retail shops, Korean restaurants, hair salons, laundromats. For this kind of relocation, D-8 is not the right visa — a different category applies." }
      ]
    },
    {
      id: "s2",
      heading: "D-9-4 and D-9-5 — visas designed for foreign sole proprietors",
      blocks: [
        { type: "p", text: "Korea maintains a separate visa track for <b>foreign sole proprietors</b>: <b>D-9-4</b> and <b>D-9-5</b>." },
        {
          type: "table",
          title: "D-9-4 · D-9-5 at a Glance",
          headers: ["Visa", "Eligible Applicant", "Minimum Investment"],
          rows: [
          ...
          note: "Both visas are open to all nationalities and impose virtually no industry restrictions."
        },
        { type: "p", text: "<b>D-9-4</b> does not involve setting up a corporation. The applicant registers a business under their own name as a sole proprietor. Nationality is unrestricted, and the range of eligible industries is extremely broad." },
        { type: "p", text: "<b>D-9-5</b> is a special-track visa for <b>former international students who graduated from a Korean university</b>. It allows those who completed their studies in Korea to continue in Korea as entrepreneurs rather than return home, with a substantially lower investment threshold." },
        { type: "callout", text: "Although both visas directly correspond to sole-proprietor small business immigration, <b>these categories are almost entirely absent from the Korea sections of overseas immigration consultancy materials</b>. Because D-8 has become the default reference point for \"Korean business visas,\" many applicants either give up on Business Immigration to Korea altogether or pursue an ill-fitting D-8 path — simply unaware that the sole-proprietor route exists." },
        { type: "p", text: "<b>Lawyeon Visa & Immigration Center specializes in D-9-4 and D-9-5 — the sole-proprietor Business Immigration track for foreign nationals.</b> We integrate the regulatory, contractual, and operational aspects of Korean sole-proprietor immigration into a single project, and this is our dedicated practice area." }
      ]
    },
    {
      id: "s3",
  ...
  related: [
    ...
    { tag: "EP 3", title: "What Actually Happens When You Start a Business in Korea" },
