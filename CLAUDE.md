...
- 원고 작성·수정·게시 전 `docs/insights-article-guide.md`의 편집 원칙을 적용한다.
- 분량·문단 수·도입문·FAQ·본문 CTA를 고정하지 않는다. 승인 원고의 문구와 문단을 게시 과정에서 임의로 추가·축약하지 않는다.
- 규정·재결 출처 링크, 출처 연도 강조, ‘공개자료’ 같은 조사 경위 문구는 발행본문에서 제외한다. 필요한 지침명·기준명만 명시하고 검증 근거는 내부에 보관한다.
